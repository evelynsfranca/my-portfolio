...
export const projects: ProjectModel[] = [
  {
    ...
    resume: "Desenvolvido como projeto final de curso, o site <strong>D’gusto La Pizza</strong> foi criado para digitalizar e otimizar o gerenciamento de uma pizzaria, permitindo tanto a interação dos clientes com os serviços quanto o gerenciamento completo por parte do administrador.",
    versions: [
      {
        tag: "1.6.0",
        repositories: [
